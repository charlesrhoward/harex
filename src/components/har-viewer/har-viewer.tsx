...
export function HarViewer() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-zinc-800 dark:bg-zinc-950 dark:text-zinc-100">
      <header className="sticky top-0 z-10 bg-zinc-100 dark:bg-zinc-800 lg:bg-transparent lg:dark:bg-transparent border-b border-zinc-200 dark:border-zinc-800">
        <div className="relative flex justify-between h-16 mx-auto lg:container lg:px-16 xl:px-20">
          <div className="flex items-center px-6 lg:px-0 flex-1 sm:items-stretch justify-between">
            <div className="flex items-center">
              <div className="flex items-center flex-shrink-0">
                <Link className="block w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground-lighter flex items-center" href="/">
                  <div className="text-black dark:text-emerald-400">
            ...
            <div className="flex items-center gap-2 opacity-100 animate-fade-in !scale-100">
              <a 
