  ...
  return (
    <div
      className={`mt-8 p-12 rounded-lg text-center border-2 border-dashed ${
        dragActive ? "border-emerald-400" : "border-zinc-700"
      } transition-colors bg-zinc-800 shadow-lg max-w-3xl mx-auto`}
    ...
    >
      ...
      <h2 className="text-2xl font-semibold mb-3">Upload HAR File</h2>
      <p className="mb-6 text-zinc-300 max-w-md mx-auto">
